...
%\ec
\begin{abstract}
Standard measures of economic mobility do not account for the possible non-ergodic wealth dynamics. Thus, they may fail to provide an adequate picture for the extent of mobility within an economy. As a solution to this problem, here we introduce mixing time as a measure of economic mobility. Mixing time quantifies the time scale over which individuals mix into the wealth distribution. By construction, it is finite only in an ergodic system and then there is a direct equivalence between its value and the magnitude of the standard measures of economic mobility. On the other hand, the opposite is not true. Hence, measuring mobility using standard measures in a non-ergodic system may be misleading. We display the properties of mixing time by studying mobility in reallocating geometric Brownian motion – an established model of wealth in a growing and reallocating economy.
...
Nevertheless, another transformation of wealth might exist which is ergodic, and mixing time in terms of it will be a finite value. Then mobility will definitely exist but it should be defined in terms of an another dimension. The dimension through which economic mobility is defined is relevant for policymakers to produce adequate measures for its optimization. This is because, the extent to which mobility is socially desirable is illuminated by the dimension through which it is studied. An increase in economic mobility will not always translate into increased economic welfare. We refer to \citet{JanttiJenkins2015} for a lengthy discussion on the various dimensions of economic mobility and their social implications.
